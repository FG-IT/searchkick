...
module Searchkick
  ...
  class << self
    attr_accessor :search_method_name, :wordnet_path, :timeout, :models, :client_options, :redis, :index_prefix, :index_suffix, :index_with_timestamp, :queue_name, :model_options
  ...
  self.model_options = {}
  self.index_with_timestamp = true
